...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.allow_option_creation = false;
      return this.allow_option_creation_comma = false;
    };
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.winnow_results = function() {
      var found, fregex, option, part, parts, regex, regexAnchor, result, result_id, results, searchText, startpos, text, textToSearch, zregex, _i, _j, _len, _len1, _ref;
    ...
    Chosen.prototype.keydown_checker = function(evt) {
      ...
      switch (stroke) {
        case 8:
          ...
          break;
        case 9:
          if (this.results_showing && !this.is_multiple || this.options.allow_option_creation) {
    ...
    Chosen.prototype.search_field_remove_comma = function() {
      return this.search_field.value = this.search_field.value.replace(',', '');
    };
